...
<html lang="en" class="light-style layout-menu-fixed" dir="ltr" data-theme="theme-default"
    data-assets-path="/mentor_assets/assets/" data-template="vertical-menu-template-free">
...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{ asset('mentor_assets/assets/img/favicon/favicon.png') }}" />
...
<body>
        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item {{ request()->routeIs('mentor.my-athletes') ? 'active' : '' }}">
                        <a href="{{ route('mentor.my-athletes') }}" class="menu-link">
                            <i class="fas fa-layer-group"></i>
                            <div>My Athletes</div>
                        </a>
                    </li>
    ...
    ? asset('mentor_assets/images/' . Auth::user()->image)
    : asset('mentor_assets/assets/img/avatars/1.png') }}" class="w-px-40 h-auto rounded-circle">
                                        </div>
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="{{ route('mentor.deactivate.view') }}">
                ...
                <div class="content-wrapper">
                    ...
                    <footer class="content-footer footer bg-footer-theme text-end px-4 py-2">
                        © {{ date('Y') }}
                        Alumni India. Powered by<a href="https://www.banttech.com/" target="_blank"
                            class="text-decoration-none"> <b style="color: #fff;">Banttech</b>
                        </a>
                    </footer>
                </div>
                <!-- ================= /CONTENT ================= -->
