...
<body style="margin: 0; padding: 0; -webkit-text-size-adjust: 100%; background-color: #e3e3e3;">
            ...
            <tr>
                <td style="word-break: break-word; vertical-align: top; padding: 20px 10px;">
                    ...
                    <div class="email-container"
                        style="    background-color: #0057b8;min-width:320px;max-width:654px;margin:0 auto;border-radius:8px 8px 0 0; padding:12px;">
                                    ...
                                    <td class="content-padding" style="padding: 30px 25px;">
                                        <div style="text-align: left;">
                                            ...
                                            <p class="text-content"
                                               ...
                                               We are pleased to inform you that your university has been successfully added to the platform.
                                            <br>You can now access your university admin dashboard using the login credentials provided below:
                                            </p>
                                        </div>
    ...
    margin: 20px 0 0 0;">
                                            ...
                                            <br>
                                            Through your admin dashboard, you will be able to manage alumni data, update university information, and access platform features.
                                            <br><br>
                                        ...
                                        <div
                                            ...
                                            <p style="font-size: 17px; color: #121212; font-weight: 500; margin: 0;">
                                                Team,</p>
                                            <p
                                                style="font-size: 18px; color:#0057b8; font-weight: 600; margin: 5px 0 0 0;">
                                                AlumniIndia 
                                            </p>
                                        </div>
                                    </td>
                    ...
                    <!-- Footer -->
                    <div class="email-container"
                        style="background-color: #0057b8; min-width: 320px; max-width: 680px;    margin-top: -22px; margin: 0 auto; border-radius: 0 0 8px 8px;">
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tbody>
                                <tr>
                                    <td
