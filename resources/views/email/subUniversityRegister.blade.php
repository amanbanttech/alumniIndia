                                    ...
                                    <td class="content-padding" style="padding: 30px 25px;">
                                        <div style="text-align: left;">
                                            ...
                                            <p class="text-content"
                                               ...
                                               We are pleased to inform you that you are successfully added as a Sub University Admin to the platform.
                                            <br>You can now access your dashboard using the login credentials provided below:
                                            </p>
                                        </div>
