                    ...
                    <div class="post-card">
                        ...
                        <div class="post-user">
                          ...
                          <div>
                            ...
                            <div class="user-location" id="userCountry">
                              <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#6b7a8f" stroke-width="2">
                      ...
                      <div class="post-image-wrap">
                        <video id="athleteVideo" controls autoplay muted loop width="100%">
                          <source id="videoSource" src="{{ env('BUNNY_BASE_URL') . '/' . ($allVideos[0]['video'] ?? '') }}">
                        </video>
                      </div>
                      <!-- ACTIONS (like) -->
                      ...
                      <div class="post-actions">
                        <div class="action-left">
                          <button class="action-btn likeBtn" id="likeBtn" data-video="{{ $allVideos[0]['id'] ?? '' }}">
                        ...
                        <div class="video-info">
                          <div class="channel-row">
                            <div class="channel-avatar">
                              <img src="{{ asset('athlete_assets/athlete_documents/' . $video['profile']) }}">
                            </div>
