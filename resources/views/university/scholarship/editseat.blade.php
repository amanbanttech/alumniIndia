                ...
                <div class="col-xxl">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('university.scholarship.updateseat', $seat->id) }}" method="POST" novalidate>
                                @csrf
@method('PUT')
                                {{-- Sport Name --}}
                                            ...
                                            <select name="sport_id" class="form-control">
                                                ...
                                                @foreach($sports as $sport)
                                                    @if($sport->sport)
                                                        ...
                                                        {{ old('sport_id', $seat->university_sport_id) == $sport->id ? 'selected' : '' }}>
                                                            {{ $sport->sport->name }}
                                                        </option>
                                                    @endif
                                                @endforeach
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-sm-12 select-wrapper">
                                            <select name="seat_alloted" class="form-control">
                                                ...
                                                @for($i = 1; $i <= 50; $i++)
                                                    <option value="{{ $i }}"
                                                    {{ old('seat_alloted', $seat->seat_alloted) == $i ? 'selected' : '' }}>{{ $i }}</option>
                                                @endfor
                                            ...
                                            <select name="course_id" class="form-control" required>
                                                ...
                                                @foreach($courses as $course)
                                                    <option value="{{ $course->id }}"
                                                     {{ old('course_id', $seat->course_id) == $course->id ? 'selected' : '' }}>{{ $course->name }}</option>
                                                @endforeach
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" name="scholarship_amount" class="form-control"
                                                value="{{ old('scholarship_amount', $seat->scholarship_amount) }}"
