...
<head>
    ...
    <title>AlumniIndia - University Login</title>

    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{ asset('university_assets/assets/img/favicon/favicon.ico') }}" />
    ...
    <!-- Page CSS -->
    <link rel="stylesheet" href="{{ asset('university_assets/assets/vendor/css/pages/page-auth.css') }}" />
...
<body>
                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bolder">AlumniIndia</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-2">Welcome to AlumniIndia!</h4>
                        ...
                        <form id="otpLoginForm" class="mb-3">
                            ...
                            {{-- Submit --}}
                            <div class="mb-3">
                                <button type="submit" id="loginBtn" class="btn btn-primary d-grid w-100">
                                    Log In
                                </button>
                            </div>
                        </form>
    ...
    <script src="{{ asset('university_assets/assets/vendor/libs/popper/popper.js') }}"></script>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            sendOtpBtn.onclick = function () {
                ...
                fetch("{{ route('university.send.login.otp') }}", {
                    method: "POST",
                    headers: {
            ...
            otpInput.addEventListener("keyup", function () {
                ...
                fetch("{{ route('university.verify.login.otp') }}", {
                    method: "POST",
                    headers: {
                        "Content-Type": "application/json",
                        "X-CSRF-TOKEN": "{{ csrf_token() }}"
                    ...
                    .then(data => {
                        if (data.status) {
                            showSuccessMessage(data.message || "OTP verified successfully");
            ...
            loginForm.addEventListener("submit", function (e) {
                ...
                if (!otpVerified) {
                    ...
                    otpResult.scrollIntoView({ behavior: "smooth", block: "center" });
                    return;
                }

                if (phone.value !== verifiedPhone) {
                    showErrorMessage("Phone number changed. Please verify again.");
                    return;
                }
