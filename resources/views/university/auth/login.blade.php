...
<body>
    <div class="auth-wrapper">
        <div class="auth-left">
            ...
            <img src="{{ asset('university_assets/images/university-logins.png') }}" alt="University Illustration">
        </div>
        <div class="auth-right">
            <a href="index.html" class="only-mobiles">
                <img src="{{ asset('university_assets/images/logo-black.png') }}" alt="logo">
            </a>
            <div class="login-left-new">
                <i class="fa fa-university"></i><br>
                <h1>University Log In</h1>
                <p>Securely access your university dashboard to manage alumni data and platform operations.</p>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            loginForm.addEventListener("submit", function (e) {
                ...
                if (!mobile) {
                    showErrorMessage("Please enter a valid your mobile number.");
                    phone.focus();
                    return;
                }
