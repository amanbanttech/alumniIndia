                ...
                <div class="col-xxl">
                    <div class="card mb-4">
                        <div class="simple-dashboard-heading">
                            ...
                            <span>Edit Sub-University Admin</span>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('subUniversity.update', $subUniversity->id) }}" method="POST"
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" name="name" class="form-control"
                                                value="{{ $subUniversity->name }}"
                                                placeholder="Enter your sub-university admin name">
                                            @error('name')
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-sm-12 d-flex gap-2 position-relative">
                                            <input type="text" name="mobile" id="mobile" class="form-control"
                                                value="{{ $subUniversity->user->phoneNumber }}"
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" name="email" class="form-control"
                                                value="{{ $subUniversity->user->email }}" placeholder="Enter your email">
                                            @error('email')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
