...
class UniversityAuthController extends Controller
{
        ...
        try {
            ...
            if (!$user) {
                return response()->json([
                    'status' => false,
                    'not_registered' => true,
                    'message' => 'We couldn\'t find a university account associated with this phone number.'
                ], 422);
            }
            ...
            $otp = $this->createOtp($request->mobile, 'university_login');
    ...
    public function verifyLoginOtp(Request $request)
    {
        try {
            ...
            $result = $this->validateOtp($request->mobile, $request->otp, 'university_login');
    ...
    public function login(Request $request)
    {
        ...
        try {
            ...
            return response()->json([
                ...
                'redirect' => route('university.dashboard')
            ]);
        } catch (\Exception $e) {
